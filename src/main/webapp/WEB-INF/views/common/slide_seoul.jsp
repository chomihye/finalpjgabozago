...
<body>
  ...
  <div class="slideContainer">
    ...
    <div id="seoul" class="carousel slide" data-touch="false" data-interval="false">

      <!-- 여행제목 + 닉네임 -->
      <div class="userInfo">
        <ul>
          <li class="title">서울여행</li>
      ...
      <button id="leftArrow" class="carousel-control-prev arrows" type="button" data-target="#seoul" data-slide="prev">
        <span class="bi bi-arrow-left-circle-fill" aria-hidden="true"></span>
      </button>

      <button id="rightArrow" class="carousel-control-next arrows" type="button" data-target="#seoul" data-slide="next">
        <span class="bi bi-arrow-right-circle-fill" aria-hidden="true"></span>
      </button>


      <button class="planAdd">일정에 추가</button>
