...
public class MessageService  {
	...
	// 설정 변경 X
	static final String api_key = "NCSAZ5E97ZPWMERQ";
	static final String api_secret = "IZIBQUG7TKCSX9LJCCUYPKTHZVG85CA7";
	static final String fromNumber = "010-8741-9039";

	public void sendMessageforFindPw(String toNumber, String randomNumber) {
	    Message coolsms = new Message(api_key, api_secret);
	    
		HashMap<String, String> params = new HashMap<String, String>();
		params.put("to", toNumber); // 받는 사람 번호
		params.put("from", fromNumber); // 보내는 사람 번호
		params.put("type", "SMS"); // 설정 변경 X
		params.put("text", "[가보자고] 임시 비밀번호는 " + randomNumber + " 입니다. 로그인 후 꼭 비밀번호를 변경해주세요.");
		params.put("app_version", "test app 1.2"); // 설정 변경 X
