...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="/resources/board/css/notice.css">
                ...
                <div class="menu">
                    <ul>
                        <li class="no">
                            <div>
                                <a href="/board/notice">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-pin-angle" viewBox="0 0 16 16">
                        ...
                        <li class="qn">
                            <div>
                                <a href="/board/qna">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-patch-question" viewBox="0 0 16 16">
                        ...
                        <table class="board_list notice_table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="num">5</td>
                                    <td class="title_N">
                                        <a href="/board/notice/read">[한국관광공사] 관광데이터에도 인공지능 도입한다</a>
                                    </td>
                                ...
                                <tr>
                                    <td class="num">4</td>
                                    <td class="title_N">
                                        <a href="#">[산림청] 울진금강소나무숲길, 미소와 친절로 맞이하다</a>
                                    </td>
                                ...
                                <tr>
                                    <td class="num">3</td>
                                    <td class="title_N">
                                        <a href="#">[농림축산식품부] 한국의 명소에서 김치의 매력을 느껴보세요!</a>
                                    </td>
                                    <td class="date">2022-09-16</td>
                                    <td class="views">85</td>
                                </tr>
                                <tr>
                                    <td class="num">2</td>
                                    <td class="title_N">
                                        <a href="#">[한국관광공사] 오딩이와 함께 떠나는 스타필드 가을여행 추천</a>
                                    </td>
                                ...
                                <tr>
                                    <td class="num">1</td>
                                    <td class="title_N">
                                        <a href="#">[한국관광공사] 서비스 중단된 유튜브 채널 복구 및 재발 방지 긴급 대책 수립</a>
                                    </td>
                                    <td class="date">2022-09-08</td>
                                    <td class="views">80</td>
                                </tr>
                            </tbody>
                        </table>
