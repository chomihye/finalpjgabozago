...
<body>
            ...
            <div id="body">        
                ...
                <form action="modify.do" method="POST" id="form">
                    ...
                    <div class="sections">
                        ...
                        <button class="formCheckBox" id="phoneValidationBtn" onclick="clickVerifyBtn()">인증</button>
                    </div>
    ...
    <!-- 휴대폰 번호 중복 모달 -->
    <div class="modal" id="phoneDoubleModal">
        <div class="modal_Content">
            <p class="center simpleTextSpaceAdd">중복된 휴대폰 번호입니다.</p>
            <div class="okBtn onlyOk continue">확인</div>
        </div>
    </div>
    ...
    <div class="modal" id="phoneModal">
        <div class="modal_Content">
            ...
            <div id="phoneValidation">
                ...
                <button id="phoneValidationNumBtn" onclick="checkVerifyNum()">확인</button>
            </div>
