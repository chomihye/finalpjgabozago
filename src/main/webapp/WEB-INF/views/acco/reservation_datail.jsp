        ...
        <ul class="np-box">
          ...
          <li>
            ...
            <div>
              ...
              <input type="text" id="dateSelector2" class="datepicker_input" name="spot" placeholder="체크아웃 날짜를 선택하세요" />
            </div>
          </li>
          <li>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide room_card">
            <div class="room_card_warp">
              ...
              <div class="room_type">스탠다드 트윈</div>
          ...
          <div class="swiper-slide room_card">
            <div class="room_card_warp">
              ...
              <div class="room_type">스탠다드 더블</div>
    ...
    <div class="wrap">
      <div class="avg_box">
        ...
        <div class="progress_box">
          <div class="avg_star_bar">
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star-fill"></i>
            <div class="progress_bar"><span></span></div>10명
          </div>
          ...
          <div class="avg_star_bar">
            ...
            <i class="bi bi-star-fill"></i>
            <i class="bi bi-star"></i>
            <div class="progress_bar"><span></span></div>7명
          </div>
          ...
          <div class="avg_star_bar">
            ...
            <i class="bi bi-star"></i>
            <i class="bi bi-star"></i>
            <div class="progress_bar"><span></span></div>5명
          </div>
          ...
          <div class="avg_star_bar">
            ...
            <i class="bi bi-star"></i>
            <i class="bi bi-star"></i>
            <div class="progress_bar"><span></span></div>3명
          </div>
          ...
          <div class="avg_star_bar">
            ...
            <i class="bi bi-star"></i>
            <i class="bi bi-star"></i>
            <div class="progress_bar"><span></span></div>1명
          </div>
        </div>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide star_box">
            <div class="star_box_wrap">
              <div class="star_name ">Jhone Lown</div>
              <div class="np-box">
                <p class="star_review ">
                  <i class="bi bi-star-fill"></i>
                  <i class="bi bi-star-fill"></i>
          ...
          <div class="swiper-slide star_box">
            <div class="star_box_wrap">
              <div class="star_name">jenny choi</div>
              <div class="np-box">
                <p class="star_review">
                  <i class="bi bi-star-fill"></i>
                  <i class="bi bi-star-fill"></i>
