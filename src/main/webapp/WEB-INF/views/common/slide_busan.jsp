...
<body>
  ...
  <div class="slideContainer">
    ...
    <div id="busan" class="carousel slide" data-touch="false" data-interval="false">

      <!-- 여행제목 + 닉네임 -->
      <div class="userInfo">
        <ul>
          <li class="title">부산여행</li>
      ...
      <button id="leftArrow" class="carousel-control-prev arrows" type="button"
        data-target="#busan" data-slide="prev">
      ...
      <button id="rightArrow" class="carousel-control-next arrows" type="button"
        data-target="#busan" data-slide="next">
