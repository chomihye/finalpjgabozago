...
<body>
  ...
  <div class="slideContainer">
    ...
    <div id="jeju" class="carousel slide" data-touch="false" data-interval="false">

      <!-- 여행제목 + 닉네임 -->
      <div class="userInfo">
        <ul>
          <li class="title">제주여행</li>
      ...
      <button id="leftArrow" class="carousel-control-prev arrows" type="button"
        data-target="#jeju" data-slide="prev">
      ...
      <button id="rightArrow" class="carousel-control-next arrows" type="button"
        data-target="#jeju" data-slide="next">
