                ...
                <div class="term_wrap">
                    ...
                    <div class="term_box">
                        <p>
                            ...
                            마이리얼트립은 위치정보의 보호 및 이용 등에 관한 법률에 따라 이용자의 개인위치정보를 안전하게 관리합니다.

                            개인위치정보의 처리목적 및 보유기간

                            : 마이리얼트립은 위치정보 이용약관에서 정한 목적 범위 내에서 개인위치정보를 수집‧이용하며, 개인위치정보를 일회성으로 이용 후 지체 없이 파기합니다.
                            ...
                            : 마이리얼트립은 개인위치정보의 처리목적이 달성된 경우, 개인위치정보를 재생이 불가능한 방법으로 안전하게 파기하고 있습니다. 전자적 파일 형태는 복구 및 재생이
                            불가능한
                            기술적인
                            방법으로
                            파기하며, 출력물 등은
                            ...
                            : 마이리얼트립은 이용자의 사전 동의 없이 개인위치정보를 제3자에게 제공하지 않으며, 이용자가 지정한 제3자에게 개인위치정보를 제공하는 경우 매회 개인위치정보주체에게
                            제공받는 자,
                            제공일시 및 제공목적을 즉시
                            통보합니다.
                            ...
                            : 마이리얼트립은 아래의 경우에 해당하는 자(이하 “8세 이하의 아동 등”)의 위치정보의 보호 및 이용 등에 관한 법률 제26조2항에 해당하는 자(이하
                            “보호의무자”)가
                            8세
                            이하의 아동
                            등의 생명 또는 신체보호를
